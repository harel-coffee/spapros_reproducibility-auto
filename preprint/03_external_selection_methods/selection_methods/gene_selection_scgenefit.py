...
def preprocess_adata_scgenefit(adata, hyper_parameter1, size_factors="size_factors"):
...
def select_genes_scgenefit(n, adata, label, hierarchical, hyper_parameter1, size_factors="size_factors", method='centers', epsilon=1, sampling_rate=1,
